...
class CreateCardFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        btnSalva.setOnClickListener { handleSave() }
        btnAnnulla.setOnClickListener { handleCancel() }

        return view
    }

    /** Handles save button logic with validation */
    private fun handleSave() {
        ...
        viewModel.addScheda(Card(nome, esercizi))

        Toast.makeText(
            requireContext(),
            getString(R.string.scheda_salvata),
            Toast.LENGTH_SHORT
        ).show()
    ...
    /** Handles cancel button with confirmation dialog */
    ...
    /** Adjusts dialog width for better layout appearance */
